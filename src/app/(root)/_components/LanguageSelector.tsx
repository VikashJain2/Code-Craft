  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <div className="w-6 h-6 rounded-md bg-gray-800/50 p-0.5 group-hover:scale-110 transition-transform">
          <Image
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-64 bg-[#1e1e2e]/95 backdrop-blur-xl rounded-xl border border-[#313244] shadow-2xl py-2 z-500"
          >
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className={`relative w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 ${language === lang.id ? "bg-blue-500/10 text-blue-400" : "text-gray-300"} `}
                    >
                      ...
                      <div
                        className={`relative w-8 h-8 rounded-lg p-1.5 group-hover:scale-110 transition-transform ${language === lang.id ? "bg-blue-500/10" : "bg-gray-800/50"}`}
                      >
                      ...
                      {/* selected Language border indicator */}
