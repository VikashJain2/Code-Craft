...
export const THEMES: Theme[] = [
  ...
  { id: "atom-one-dark", label: "Atom One Dark", color: "#282C34" },
  { id: "dracula", label: "Dracula", color: "#282a36" },
  { id: "nord", label: "Nord", color: "#2e3440" },
  { id: "palenight", label: "Palenight", color: "#292D3E" },
  { id: "one-light", label: "One Light", color: "#fafbfc" },
];
...
export const THEME_DEFINITONS = {
  ...
  nord: {
    ...
    inherit: true,
    rules: [
      { token: "comment", foreground: "8fbcbb" },
  ...
  palenight: {
    ...
    rules: [
      ...
      { token: "string", foreground: "C5C8C6" },
      { token: "keyword", foreground: "F07178" },
      { token: "number", foreground: "F3B8A5" },
      { token: "type", foreground: "A8C8F3" },
      { token: "class", foreground: "A8C8F3" },
      { token: "function", foreground: "C5C8C6" },
      { token: "variable", foreground: "D0D0D0" },
      { token: "operator", foreground: "F07178" },
    ],
    colors: {
      "editor.background": "#292D3E",
      "editor.foreground": "#C5C8C6",
      "editorLineNumber.foreground": "#7C7C7C",
      "editor.selectionBackground": "#4A4E64",
      "editor.lineHighlightBackground": "#4A4E64",
      "editorCursor.foreground": "#F07178",
      "editor.selectionHighlightBackground": "#4A4E64",
    },
  },
  "one-light": {
    base: "vs",
    ...
    rules: [
      ...
      { token: "function", foreground: "032F62" },
    ...
    colors: {
      ...
      "editor.selectionBackground": "#a0c1d1",
      "editor.lineHighlightBackground": "#f1f8ff",
      "editorCursor.foreground": "#032F62",
      "editor.selectionHighlightBackground": "#a0c1d1",
    },
  },
};
